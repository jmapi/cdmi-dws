...
public class PraiseServiceImpl implements PraiseService {
	...
	public void praiseObject(PraiseRequest praiseRequest) {
		...
		praise.setUserUid(praiseRequest.getOwner().getId());
		praise.setHeadImage(praiseRequest.getOwner().getHeadImage());
		praise.setUserName(praiseRequest.getOwner().getName());
		
		praise.setTargetId(praiseRequest.getTarget().getId());
		praise.setTargetType(praiseRequest.getTarget().getType());
