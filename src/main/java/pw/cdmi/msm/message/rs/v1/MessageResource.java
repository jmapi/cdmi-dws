...
import pw.cdmi.msm.message.rs.NotifyMessageRequst;
...
public class MessageResource {
    ...
    @PostMapping("/message") 
    public @ResponseBody String createMessageHandler(@RequestBody  MessageRequest messageRequest) {
        String newid = null;
    ...
    public @ResponseBody List<NotifyMessageResponse> listNotifyMessageResponse(@RequestParam("userId") String userId){
    ...
    public @ResponseBody List<NotifyMessageResponse> listNotifyMessageResponse(@RequestParam("userId") String userId,@RequestParam("cursor") Integer cursor,
